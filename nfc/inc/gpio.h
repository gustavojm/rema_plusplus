...
public:
    ...
    gpio_pinint(int scu_port, int scu_pin, int scu_mode, int gpio_port, int gpio_bit, LPC43XX_IRQn_Type IRQn) : gpio(scu_port, scu_pin, scu_mode, gpio_port, gpio_bit), IRQn(IRQn) {
