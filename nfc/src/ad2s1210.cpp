 ...
 */
int32_t ad2s1210::config_write(uint8_t data)
{
	int32_t ret = 0;
 ...
 */
uint8_t ad2s1210::config_read(uint8_t address)
{
	...
	for (uint32_t i = 0; i < xfers_count; i++) {
		/* @formatter:off */
	...
	spi_sync_transfer(xfers, xfers_count, gpios.wr_fsync);
 ...
 * 			address was put on the bus.
 */
uint16_t ad2s1210::config_read_two(uint8_t address)
{
	...
	int32_t ret = 0;
	ret = spi_sync_transfer(xfers, xfers_count, gpios.wr_fsync);
	if (ret < 0)
		return ret;
 ...
 * @returns resolution
 */
uint8_t ad2s1210::get_resolution()
{
	return resolution;
}
 ...
 */
uint8_t ad2s1210::get_reg(uint8_t address)
{
	uint8_t ret = 0;
 ...
 */
uint16_t ad2s1210::read_position()
{
	uint16_t pos = 0;
 ...
 */
int16_t ad2s1210::read_velocity()
{
	int16_t vel = 0;
 ...
 */
uint8_t ad2s1210::get_fault_register()
{
	uint8_t ret = 0;
 ...
 * @returns nothing
 */
void ad2s1210::print_fault_register()
{
 ...
 * @returns nothing
 */
uint8_t ad2s1210::clear_fault_register()
{
	gpios.sample(0);
