...
{
    {
        ...
        gpio ZSz_out   = gpio {4, 2, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 2, 2}.init_input();    //DIN2 P4_2     PIN8   GPIO2[2]   ZSz-
        gpio ZSz_in    = gpio {4, 3, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 2, 3}.init_input();    //DIN3 P4_3     PIN7   GPIO2[3]   ZSz+

        int gpio_port = 2;
        int bitmask = 1 << ZSz_out.gpio_bit | 1 << ZSz_in.gpio_bit;
...

    {
        ...
        gpio ZSy_up   = gpio {7, 3, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 3, 11}.init_input();    //DIN4 P7_3     PIN117   GPIO3[11]   ZSz-
        gpio ZSy_down = gpio {7, 4, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 3, 12}.init_input();    //DIN5 P7_4     PIN132   GPIO3[12]   ZSy+
        gpio ZSx_right = gpio {7, 5, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 3, 13}.init_input();   //DIN6 P7_5     PIN133   GPIO3[13]   ZSy-
        gpio ZSx_left = gpio {7, 6, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC0), 3, 14}.init_input();    //DIN7 P7_6     PIN134   GPIO3[14]   ZSx+

        int gpio_port = 3;
        int bitmask = 1 << ZSy_up.gpio_bit | 1 << ZSy_down.gpio_bit | 1 << ZSx_right.gpio_bit | 1 << ZSx_left.gpio_bit;
