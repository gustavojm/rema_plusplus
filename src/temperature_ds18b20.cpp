...
using gpio_ow =
    gpio_templ<2, 5, SCU_MODE_FUNC4 | SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP, 5,
...
void temperature_ds18b20_init() {
  xTaskCreate(temperature_ds18b20_task, "DS18B20", configMINIMAL_STACK_SIZE * 2,
              NULL, TEMPERATURE_DS18B20_TASK_PRIORITY, NULL);
