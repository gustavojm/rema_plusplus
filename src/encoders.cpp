...
void encoders_init(void) {
    ...
    gpio_pinint encoders[] = {
            // gpio_pinint {2, 5, (SCU_MODE_INBUFF_EN | SCU_MODE_PULLUP | SCU_MODE_FUNC4), 5, 5, PIN_INT0_IRQn},    //GPIO1 P2_5     PIN91   GPIO5[5]    EncAx  (Conn P12)   TODO TEMPORALMENTE UTILIZADO POR TEMPERATURA
